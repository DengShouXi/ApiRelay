...
| `v1.12` | `aed14a0` | 2026-08-11 02:54 | 小迭代 12 — Stage1 代码调整与体验优化；本 tip 起含简体中文分支台账 | **当前工作分支**；与 `v1` 同 tip |
| `v1` | `aed14a0` | 2026-08-11 02:54 | 大阶段 1 tip（跟随 `v1.12`）；继续在 `v1.12` 优化后再上架准备 | 推荐作为仓库默认分支；勿回退到旧名 `v0.1` tip |
