...
| `v1.13` | — | — | EN: Phase 13 Stage1 store materials (T063–T066) in progress; T062 not executed. / 中文：小迭代 13 — 上架材料进行中（T063–T066）；**未**执行 T062 | **进行中**；材料与 T062 **分对话** |
| `v1` | `531234c` | 2026-08-11 03:48 | EN: Stage1 tip at v1.12 closeout; active work on v1.13 store materials (not T062). / 中文：大阶段 1 tip（`v1.12` 关账点）；当前在 `v1.13` 做上架材料（勿直接 T062） | 推荐作为仓库默认分支；勿回退到旧名 `v0.1` tip |
