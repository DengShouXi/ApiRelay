...
> **工作分支**：`v1.13.1` 上架后热修；冻结的 `v1.13` 与 tag `release/1.0.0` 不动。  
...
| `v1` | `bc8b2fa` | 2026-08-22 | EN: Stage1 tip advances to the v1.13.1 hotfix snapshot; release references stay frozen. / 中文：大阶段 1 tip 前进到 `v1.13.1` 热修快照；已发布引用保持冻结 | `main` / `release/1.0.0` 不动 |
