...
> **工作分支**：`v1.13.9` — **身份验证、隐私链与跨存储失败关闭已冻结**。内容提交 A 已上传；记账 B、`v1` 与远端最终一致性以实时核对为准。商店号仍 **1.0.1**；源码构建号仍 **9**。冻结：`v1.13` … `v1.13.8` 与 tag `release/1.0.0` 不动。当前上传状态只看 [`ZL01/14`](../../../ZL01_具体说明/14-项目当前状态.md)。
...
| `v1` | `e48041b` | 2026-09-14 | EN: Stage1 tip follows v1.13.8 content commit A. / 中文：大阶段 1 tip 跟随 13.8 内容提交 A | `main` / `release/1.0.0` 不动 |
