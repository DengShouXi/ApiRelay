...
| `v1` | `7443613` | 2026-08-11 03:48 | EN: Stage1 tip follows v1.12; next = open v1.13 for T063–T066. / 中文：大阶段 1 tip（跟随 `v1.12`）；下一步开 `v1.13` 上架材料 | 推荐作为仓库默认分支；勿回退到旧名 `v0.1` tip |
