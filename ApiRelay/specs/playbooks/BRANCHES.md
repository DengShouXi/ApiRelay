...
> **工作分支**：仍是 `v1.13.2` 上架后热修（2026-09-04：抽出 `12`，按它重排 `00`–`11`；`10` 关账内购、Guideline 2.1、ZL 导航）；冻结的 `v1.13`、`v1.13.1` 与 tag `release/1.0.0` 不动。  
> **下一步**：备案、热修 1.0.1、H1、⌘N 仍欠；对话导航 `tools/` 尚未入库。全部确认后再另行授权商店 `1.0.1`、`main` 与 tag `release/1.0.1`。  
