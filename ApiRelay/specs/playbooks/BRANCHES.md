...
> **工作分支**：`v1.13.7` — 锁加固 Wave 1–3 已入库（宪法 v2.13.0，FR-069～074）。下一步 Wave 4 三端手测。商店号仍 **1.0.1**；源码构建号 **9**。冻结：`v1.13` … `v1.13.6` 与 tag `release/1.0.0` 不动。  
> **`v1.14`**：已开、停放，尖端与 13.6 相同；留给云同步架构，**不要在这条上改锁**。  
> **下一步**：从本线 Archive **1.0.1 (9)**，按 `锁-验收矩阵.md` 三端手测；卫生 T008 仍欠。`tools/` 入库与备案仍不急。另授权才 ff `main`、打 tag `release/1.0.1`、点 ASC「提交审核」。  
...
| `v1` | `61d5297` | 2026-09-10 | EN: Stage1 tip follows v1.13.7 Waves 1–3. / 中文：大阶段 1 tip 跟随 13.7 Wave 1–3 | `main` / `release/1.0.0` 不动 |
